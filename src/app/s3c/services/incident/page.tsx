        ...
        <form className="bento-card-light p-6 md:p-8 space-y-6">
          <div className="space-y-4">
            <div>
              ...
              <select 
                defaultValue="" 
                className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl px-4 py-3 focus:outline-none focus:border-red-500 focus:ring-1 focus:ring-red-500 transition-all text-[#0F172A]"
              >
