...
export default function PortalDashboardPage() {
  ...
  return (
    <>
      ...
      <main className="max-w-[1280px] mx-auto w-full px-4 md:px-8 py-3 md:py-8 pb-36">

        {/* ══ GREETING ═════════════════════════════════════════════ */}
        <div className="mb-3 md:mb-6">
          <h1 className="text-lg md:text-[34px] font-bold tracking-tight text-[#0F172A] mb-0.5 md:mb-1 uppercase">
            Student Portal
          </h1>
          <p className="text-[12px] md:text-[16px] text-[#64748B] font-medium flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-6 mb-4 md:mb-8">
          ...
          {/* ── ACADEMIC SNAPSHOT ─────────────── */}
          <div className="lg:col-span-5 p-3 md:p-6 flex flex-col rounded-[22px] shadow-[0_8px_30px_rgba(15,23,42,0.08)] relative overflow-hidden bg-gradient-to-br from-[#0B2F6B] via-[#0E4092] to-[#1455B7] text-white">
            ...
            <div className="mb-3 md:mb-8 z-10">
              <h2 className="text-lg md:text-[32px] font-bold text-white leading-none mb-1 md:mb-2 uppercase">BS-AI 2A</h2>
              <p className="text-[11px] md:text-[15px] text-blue-100 font-medium">Computer Science Dept.</p>
            </div>
          ...
          {/* ── QUICK ACCESS ──────────────────────────────────── */}
          <div className="lg:col-span-7 bg-[#FAFBFC] border border-[#E6EEF8] rounded-[22px] shadow-[0_8px_24px_rgba(15,23,42,0.04)] p-3 md:p-7">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-2 md:gap-6">
              {[
                ...
                <Link
                  key={item.href}
                  href={item.href}
                  className={`group flex flex-col justify-center p-2.5 md:p-6 rounded-[22px] bg-white border border-[#E6EEF8] shadow-sm transition-all duration-[250ms] ease-in-out hover:-translate-y-1.5 active:scale-[0.98] cursor-pointer h-[90px] md:h-[160px] ${item.hoverBg} ${item.hoverBorder} ${item.hoverShadow}`}
                >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-3 md:gap-6">
          ...
          {/* ── LMS DEADLINES ─────────────────────────────────── */}
          <div className="lg:col-span-7 bg-white border border-[#E6EEF8] rounded-[22px] shadow-[0_8px_24px_rgba(15,23,42,0.04)] p-3 md:p-8 pb-5 md:pb-7">
            ...
            <div className="flex flex-col gap-3">
              {/* Deadline 1 */}
              <div className="group flex items-center justify-between p-3 md:p-4 rounded-[16px] bg-white border border-[#E6EEF8] shadow-sm hover:bg-[#F8FAFC] hover:border-[#BFDBFE] hover:shadow-md transition-all duration-[250ms] cursor-pointer">
          ...
          {/* ── ANNOUNCEMENTS ─────────────────────────────────── */}
          <div className="lg:col-span-5 bg-white border border-[#E6EEF8] rounded-[22px] shadow-[0_8px_24px_rgba(15,23,42,0.04)] p-3 md:p-8 pb-5 md:pb-7">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div 
                ...
                className="flex items-center justify-between p-3 md:p-4 rounded-[16px] bg-[#FFFBEB] border border-[#FEF3C7] hover:shadow-md hover:border-[#FDE68A] transition-all duration-[250ms] cursor-pointer group"
              >
                <div className="flex items-center gap-3 md:gap-4">
              ...
              <div 
                ...
                className="flex items-center justify-between p-3 md:p-4 rounded-[16px] bg-[#EFF6FF] border border-[#DBEAFE] hover:shadow-md hover:border-[#BFDBFE] transition-all duration-[250ms] cursor-pointer group"
              >
                <div className="flex items-center gap-3 md:gap-4">
                  <div className="w-9 h-9 md:w-10 md:h-10 rounded-full bg-white flex items-center justify-center shrink-0 shadow-sm transition-transform group-hover:scale-110">
